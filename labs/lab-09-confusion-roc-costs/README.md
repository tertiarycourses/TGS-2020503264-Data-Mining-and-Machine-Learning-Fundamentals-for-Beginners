# Lab 09 — Interpret confusion metrics and error costs

**Alignment:** LO4 · K6/K7 · A7/A8
...
Train a churn classifier, inspect the confusion matrix, and compare precision, recall, F1, and ROC AUC.
...
5. Open `http://localhost:8501`, choose **Classification**, and upload `labs/lab-09-confusion-roc-costs/churn.csv`.
...
The confusion-matrix total equals the test-set size and all reported metrics are within [0,1].
