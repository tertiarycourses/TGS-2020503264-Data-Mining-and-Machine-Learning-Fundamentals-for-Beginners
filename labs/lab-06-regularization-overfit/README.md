# Lab 06 — Control overfitting with Ridge and Lasso
...
Compare Linear, Ridge, and Lasso models while varying alpha and identify the bias-variance trade-off.
...
5. Open `http://localhost:8501`, choose **Regression**, and upload `labs/lab-06-regularization-overfit/housing_regression.csv`.
...
A moderate alpha keeps test error stable; an excessively large alpha reduces R².
