# Lab 04 — Scale features before modelling

**Alignment:** LO3 · K2/K10 · A2
**Central-app workflow:** `Regression`
**Mock data:** `housing_scale.csv`

## Objective

Compare a linear model with and without a high-magnitude feature and explain why scaling matters for regularised models.
...
5. Open `http://localhost:8501`, choose **Regression**, and upload `labs/lab-04-scale-and-compare/housing_scale.csv`.
...
Ridge produces finite MAE, RMSE and R² metrics and the actual-versus-predicted points follow the diagonal.
