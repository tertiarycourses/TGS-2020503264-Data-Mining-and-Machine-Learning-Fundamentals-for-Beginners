# Lab 10 — Select K with silhouette evidence
...
Scan candidate K values, choose a defensible cluster count, and label customer segments.
...
5. Open `http://localhost:8501`, choose **Clustering**, and upload `labs/lab-10-kmeans-silhouette/customer_clusters.csv`.
...
The strongest silhouette score occurs near K=3 and the scatter plot separates three groups.
