# Lab 13 — Rank predictive features
...
Use permutation importance to rank which measurements most affect classification accuracy.
...
5. Open `http://localhost:8501`, choose **PCA & feature ranking**, and upload `labs/lab-13-feature-ranking/breast_cancer.csv`.
...
The ranking table is ordered from the largest to the smallest mean importance.
