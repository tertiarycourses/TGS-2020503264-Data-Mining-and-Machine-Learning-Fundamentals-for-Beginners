# Lab 02 — Clean, impute, and export
...
Apply median/mode imputation and export a reproducible cleaned dataset.
...
5. Open `http://localhost:8501`, choose **Data audit & preparation**, and upload `labs/lab-02-clean-impute-export/customer_quality.csv`.
...
The downloaded file contains no blank cells in the profiled columns.
