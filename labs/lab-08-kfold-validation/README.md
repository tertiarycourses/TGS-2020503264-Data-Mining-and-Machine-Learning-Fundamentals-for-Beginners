# Lab 08 — Use stratified K-fold validation

**Alignment:** LO4 · K6 · A7
**Central-app workflow:** `Cross-validation`
**Mock data:** `breast_cancer.csv`

## Objective

Estimate generalisation performance across five stratified folds instead of trusting a single split.
...
5. Open `http://localhost:8501`, choose **Cross-validation**, and upload `labs/lab-08-kfold-validation/breast_cancer.csv`.
...
Five accuracy bars appear and the reported mean lies between 0 and 1.
