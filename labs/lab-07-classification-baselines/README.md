# Lab 07 — Compare classification algorithms
...
Compare Logistic Regression, Decision Tree, Random Forest, KNN, and SVM on the same target and features.
...
5. Open `http://localhost:8501`, choose **Classification**, and upload `labs/lab-07-classification-baselines/breast_cancer.csv`.
...
At least one supplied classifier achieves accuracy above 0.90.
